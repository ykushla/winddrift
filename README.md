...
- Added top dropdown navigation.
- Added “Як працює додаток” page with calculation overview and Applied Ballistics CSV preparation instructions.
- Added “Довідник” placeholder page.
